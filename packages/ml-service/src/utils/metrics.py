"""Prometheus metrics for the Uzavita ML Service."""
...
SERVICE_INFO = Info(
    "uzavita_ml_service",
    "Uzavita ML Service build information",
)
...
REQUEST_COUNT = Counter(
    "uzavita_ml_http_requests_total",
    "Total HTTP requests received",
    labelnames=["method", "endpoint", "status_code"],
)

REQUEST_LATENCY = Histogram(
    "uzavita_ml_http_request_duration_seconds",
...
REQUESTS_IN_PROGRESS = Gauge(
    "uzavita_ml_http_requests_in_progress",
...
MODEL_INFERENCE_DURATION = Histogram(
    "uzavita_ml_model_inference_duration_seconds",
...
TRIAGE_CONFIDENCE = Histogram(
    "uzavita_ml_triage_confidence_score",
...
TRIAGE_SEVERITY_COUNT = Counter(
    "uzavita_ml_triage_severity_total",
    "Triage outcomes by severity level",
    labelnames=["severity"],
)

TRIAGE_REJECTIONS = Counter(
    "uzavita_ml_triage_rejections_total",
...
OCR_PROCESSING_DURATION = Histogram(
    "uzavita_ml_ocr_processing_duration_seconds",
...
OCR_TAMPERING_DETECTIONS = Counter(
    "uzavita_ml_ocr_tampering_detections_total",
...
LLM_TOKEN_USAGE = Counter(
    "uzavita_ml_llm_token_usage_total",
    "Total tokens consumed by LLM calls",
    labelnames=["model_name", "token_type"],
)

LLM_COST_USD = Counter(
    "uzavita_ml_llm_cost_usd_total",
...
# ---------------------------------------------------------------------------
ACTIVE_MODELS = Gauge(
    "uzavita_ml_active_models",
    "Number of models currently loaded in memory",
)

CACHE_HIT_RATE = Counter(
    "uzavita_ml_cache_hits_total",
